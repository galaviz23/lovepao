...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'SIIII TE AMO CRAYOLITA HERMOSA MUAK MUAK MUAK';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Po que no crayola?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'Solo piensalo corazon';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 12:
            ...
            document.getElementById('noBtn').innerHTML = 'MMMMMMMMMMYA OK ENTIENDO';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 16:
                document.getElementById('noBtn').innerHTML = 'ok, adios.';
                document.getElementById('noBtn').style.backgroundColor = '#F1330A';
